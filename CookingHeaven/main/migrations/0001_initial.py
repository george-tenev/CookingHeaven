...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50, validators=[django.core.validators.MinLengthValidator(50)])),
                ('description', models.TextField(blank=True, null=True)),
                ('preparation_time', models.FloatField()),
                ('cooking_time', models.FloatField()),
                ('course', models.CharField(max_length=2)),
                ('likes', models.ManyToManyField(related_name='recipe_likes_set', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='product',
            name='recipe',
            field=models.ManyToManyField(through='main.RecipeProduct', to='main.recipe'),
        ),
    ]
